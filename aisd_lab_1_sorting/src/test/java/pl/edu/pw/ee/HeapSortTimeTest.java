...
public class HeapSortTimeTest {
    ...
    public void optimistic_Case() throws IOException{
        ...
        File save = new File("src/test/java/pl/edu/pw/ee/DataHeapSortOptimistic.txt");
        save.createNewFile();
        FileWriter write = new FileWriter("src/test/java/pl/edu/pw/ee/DataHeapSortOptimistic.txt");
    ...
    public void pesimistic_Case() throws IOException{
        ...
        File save = new File("src/test/java/pl/edu/pw/ee/DataHeapSortPesimistic.txt");
        save.createNewFile();
        FileWriter write = new FileWriter("src/test/java/pl/edu/pw/ee/DataHeapSortPesimistic.txt");
    ...
    public void random_Case() throws IOException{
        ...
        File save = new File("src/test/java/pl/edu/pw/ee/DataHeapSortRandom.txt");
        save.createNewFile();
        FileWriter write = new FileWriter("src/test/java/pl/edu/pw/ee/DataHeapSortRandom.txt");
