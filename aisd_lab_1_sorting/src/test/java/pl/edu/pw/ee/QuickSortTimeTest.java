...
public class QuickSortTimeTest {
    ...
    public void optimistic_Case() throws IOException{
        ...
        File save = new File("src/test/java/pl/edu/pw/ee/DataQuickSortOptimistic.txt");
        save.createNewFile();
        FileWriter write = new FileWriter("src/test/java/pl/edu/pw/ee/DataQuickSortOptimistic.txt");
    ...
    public void pesimistic_Case() throws IOException{
        ...
        File save = new File("src/test/java/pl/edu/pw/ee/DataQuickSortPesimistic.txt");
        save.createNewFile();
        FileWriter write = new FileWriter("src/test/java/pl/edu/pw/ee/DataQuickSortPesimistic.txt");
    ...
    public void random_Case() throws IOException{
        ...
        File save = new File("src/test/java/pl/edu/pw/ee/DataQuickSortRandom.txt");
        save.createNewFile();
        FileWriter write = new FileWriter("src/test/java/pl/edu/pw/ee/DataQuickSortRandom.txt");
